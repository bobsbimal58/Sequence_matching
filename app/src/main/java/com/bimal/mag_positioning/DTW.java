...
/**
 * Created by Bimal Bhattarai on 11/30/2017.
 */

public class DTW {
    protected ArrayList<Float> seq1;
    protected ArrayList<Float> seq2;
    ...
    public DTW(ArrayList<Float> sample, ArrayList<Float> templete) {
        seq1 = sample;
        seq2 = templete;
